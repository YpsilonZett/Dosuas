...
\begin{abstract}
	...
	Das Projekt besteht aus zwei Unterprojekten, für die momentan zwei Prototypen entwickelt
	werden. Die Projekte sollen später verglichen und das erfolgreichere ausgewählt werden.\par
	Einmal werden Bilder einer 3D-Kamera
	...
	sich mit Klicklauten orientieren kann. Letzteres ähnelt der Technik der aktiven
...
nicht für eine solche Reizüberlastung ausgelegt ist.\par 
...
\begin{figure}[H] \label{us_device}
	\centering
	\includegraphics[width=0.6\textwidth]{us_device}
	\caption{Das aktuelle Gerät zur Echoortung. Links: Ultraschalltransmitter (in der Mitte) 
	und -empfänger (oben und unten), in der Mitte: Arduino zur Triggerung, rechts: K0pfhörerausgang}
\end{figure}
...
Tiefenbild. Dieses wird vom Sensor als 2D Matrix von 320$\times$240 (=76800) natürlichen Zahlen dargestellt.
...
der späteren Bildverarbeitung hervorrufen würden.
 Momentan filtern
...
bewegt sich immer vom linken zum rechten Rand des Sicht-, bzw. Hörfeldes und ändert dabei (meistens) fortwährend
...
\begin{enumerate}
	...
	Voxel bilden einen Streifen, weil pro Spalte im Bild nur ein Voxel genommen wird), 
	z. B. durch Tonüberlagerungen, Schwebungen, Akkorde, Tonlautstärke oder unterschiedliche
	Klangfarben 
	\item Benutzen eines auf das Projekt angepassten Sensors, der dadurch günstiger wird
	\item Benutzen mehrerer Sensoren für 3d Sichtfeld (wir können aus jeder Richtung Töne hören,
